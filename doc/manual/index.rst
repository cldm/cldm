...
Download **CLDM** from https://github.com/mmontone/cldm ::
   
   git clone git@github.com:mmontone/cldm.git
...
Although **CLDM** is distributed in nature, there's central repository in progress here: http://mmontone.github.io/cldm-repo for generally useful Common Lisp libraries. **CLDM** fetches .cld definitions from there if isn't told otherwise.
