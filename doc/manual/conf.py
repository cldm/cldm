# -*- coding: utf-8 -*-
#
# CLDM documentation build configuration file, created by
...
cl_packages = {"cldm": join(dirname(realpath(__file__)), "../../")}
...
# of the sidebar.
html_logo = "logo_extra_small.png"
...
latex_documents = [
  ('index', 'CLDM.tex', u'CLDM Documentation',
...
man_pages = [
    ('index', 'cldm', u'CLDM Documentation',
     [u'Mariano Montone'], 1)
]
...
texinfo_documents = [
  ('index', 'CLDM', u'CLDM Documentation',
   u'Mariano Montone', 'CLDM', 'One line description of project.',
   'Miscellaneous'),
]
